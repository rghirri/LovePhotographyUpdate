...
<div class="fotorama" data-shuffle="true" data-keyboard="true" data-autoplay="true" data-loop="true" data-nav="thumbs" data-allowfullscreen="native" data-thumbwidth="90" data-thumbheight="50" data-transition="slide" data-clicktransition="crossfade">
    <?php 
      ...
      <div class="container">
        <div class="row">
         <?php   $specialityData = new WP_Query(array(
          ...
          <div class="mt-3 col-lg-4">
              <div class="card">
              <img class="card-img-top" src="<?php echo get_field('specialty_image')['sizes']['specialityImage']; ?>" alt="Card image cap" />
    ...
    <section id="our-sponsors">
      <div class="container">
        ...
        <div id="owl-demo-sponsors" class="owl-carousel owl-theme">
          ...
          <div class="item"><img src="<?php echo get_field('sponsors_image')['sizes']['sponsorImage']; ?>" alt="Card image cap" /></div>
          <?php } wp_reset_postdata();?>
        </div>
      </div>
    </section>
